            ...
            <div className="d-flex justify-content-center align-items-center">
              ...
              <div className="ms-3">
                <Button
                  ...
                  target="_blank"
                  href="https://github.com/insionCEO/hope-ui-react-dashboard"
                >
                ...
                <ul className="mb-2 navbar-nav ms-auto mb-lg-0 d-flex align-items-start">
                  ...
                  <Nav.Item as="li" className="me-3">
                    <Link
                      ...
                      aria-current="page"
                      to="https://hopeui.iqonic.design/pro/react/"
                      target="_blank"
                    >
                      <svg
                  ...
                  <Nav.Item as="li" className="nav-item">
                    <Link
                      ...
                      aria-current="page"
                      to="https://iqonic.design/product/admin-templates/hope-ui-free-open-source-react-admin-template/"
                      target="_blank"
                      rel="noreferrer"
                    >
                      <svg
